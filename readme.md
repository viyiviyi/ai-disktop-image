- 执行 node index.js 更换壁纸
- 可以配置为windows计划任务，操作是：启动pythonw 参数是 index.py 起始位置是index.py文件所在目录

- 需要自己准备超分辨率的软件 默认配置里用的 realesrgan-ncnn-vulkan <https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan/releases>
- 暂时只有windows的设置壁纸功能，如果要加其他平台的，需要在 app/utils/utils.js 文件内写兼容
